...
class result:
    ...
    def make_simple_analys(self, x, y):
        ...
        if x == 0 and y == 0:
            ...
            # f = open(r'C:\Users\lenovo\OneDrive - Peter the Great St. Petersburg Polytechnical University\Документы\Daniil\programming\python\projects\app_for_stakeholder\not.png'))
            # input()
            # f.close()
            return result
        elif x > 0 and y > 0:
            ...
            # f = open(r'C:\Users\lenovo\OneDrive - Peter the Great St. Petersburg Polytechnical University\Документы\Daniil\programming\python\projects\app_for_stakeholder\good_relation.png')
            # input()
            # f.close()
            return result
        elif x > 0 and y < 0:
            ...
            # f = open(r'C:\Users\lenovo\OneDrive - Peter the Great St. Petersburg Polytechnical University\Документы\Daniil\programming\python\projects\app_for_stakeholder\low_priority.png')
            # input()
            # f.close()
            return result
        else:
            ...
            # f = open(r'C:\Users\lenovo\OneDrive - Peter the Great St. Petersburg Polytechnical University\Документы\Daniil\programming\python\projects\app_for_stakeholder\protect.png')
            # input()
            # f.close()
            return result
